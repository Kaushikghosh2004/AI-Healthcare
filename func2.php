...
if(isset($_POST['patsub1'])){
  ...
  if($password==$cpassword){
    ...
    $hashed_password = password_hash($password, PASSWORD_DEFAULT);
  	$query="insert into patreg(fname,lname,gender,email,contact,password,cpassword) values ('$fname','$lname','$gender','$email','$contact','$hashed_password','$hashed_password');";
    ...
    if($result){
        ...
        // Fix: Fetch the newly inserted user's pid correctly
